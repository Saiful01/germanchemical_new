        ...
        <div class="card-body">
            ...
            <form method="post" action="/job/store" enctype='multipart/form-data'>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" placeholder="Description" id="job_description"
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" placeholder="Qualification"
                              name="job_qualification"></textarea>
                </div>
